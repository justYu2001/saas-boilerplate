 ...
 *
 * Path data is Google's own, taken verbatim from the asset they serve at
 * https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg — only the
 * editor metadata and the two cancelling transform groups were removed. Do not
 * recolour, rotate, or redraw it: Google's branding guidelines require the mark
 * unmodified on "Sign in with Google" controls.
 *
